...
<!-- UsageSnippet language="php" operationID="CreateRefund" method="post" path="/refunds" -->
```php
...
<!-- UsageSnippet language="php" operationID="ListRefunds" method="get" path="/refunds/" -->
```php
declare(strict_types=1);
...
<!-- UsageSnippet language="php" operationID="GetRefund" method="get" path="/refunds/{RefundId}" -->
```php
declare(strict_types=1);
