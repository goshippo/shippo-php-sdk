...
<!-- UsageSnippet language="php" operationID="ListParcels" method="get" path="/parcels" -->
```php
...
<!-- UsageSnippet language="php" operationID="CreateParcel" method="post" path="/parcels" -->
```php
declare(strict_types=1);
...
<!-- UsageSnippet language="php" operationID="GetParcel" method="get" path="/parcels/{ParcelId}" -->
```php
declare(strict_types=1);
