...
```php
/**
* @var Components\CarrierAccountRoyalMailCreateRequest
*/
Components\CarrierAccountRoyalMailCreateRequest $value = /* values here */
```
...
```php
/**
* @var Components\CarrierAccountRoyalMailSfCreateRequest
*/
Components\CarrierAccountRoyalMailSfCreateRequest $value = /* values here */
```
