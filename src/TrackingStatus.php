...
class TrackingStatus
{
     ...
     * @return \Shippo\API\Models\Components\Track
    ...
    public function create(Components\TracksRequest $tracksRequest, ?string $shippoApiVersion = null, ?Options $options = null): Components\Track
    {
        ...
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'CreateTrack', null, $this->sdkConfiguration->securitySource);
    ...
    public function get(string $trackingNumber, string $carrier, ?string $shippoApiVersion = null, ?Options $options = null): Components\Track
    {
        ...
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'GetTrack', null, $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $httpOptions = Utils\Utils::convertHeadersToOptions($httpRequest, $httpOptions);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
        try {
