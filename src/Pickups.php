...
class Pickups
{
     ...
     * @return \Shippo\API\Models\Components\Pickup
    ...
    public function create(Components\PickupBase $pickupBase, ?string $shippoApiVersion = null, ?Options $options = null): Components\Pickup
    {
        ...
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'CreatePickup', null, $this->sdkConfiguration->securitySource);
