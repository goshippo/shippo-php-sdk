...
class Shipments
{
     ...
     * @return \Shippo\API\Models\Components\Shipment
    ...
    public function create(Components\ShipmentCreateRequest $shipmentCreateRequest, ?string $shippoApiVersion = null, ?Options $options = null): Components\Shipment
    {
        ...
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'CreateShipment', null, $this->sdkConfiguration->securitySource);
    ...
    public function get(string $shipmentId, ?string $shippoApiVersion = null, ?Options $options = null): Components\Shipment
    {
        ...
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'GetShipment', null, $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $httpOptions = Utils\Utils::convertHeadersToOptions($httpRequest, $httpOptions);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
        try {
     ...
     *
     * @param  ?\Shippo\API\Models\Operations\ListShipmentsRequest  $request
     * @return \Shippo\API\Models\Components\ShipmentPaginatedList
     * @throws \Shippo\API\Models\Errors\SDKError
     */
    public function list(?Operations\ListShipmentsRequest $request = null, ?Options $options = null): Components\ShipmentPaginatedList
    {
        ...
        $httpOptions['headers']['user-agent'] = $this->sdkConfiguration->userAgent;
        $httpRequest = new \GuzzleHttp\Psr7\Request('GET', $url);
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'ListShipments', null, $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
