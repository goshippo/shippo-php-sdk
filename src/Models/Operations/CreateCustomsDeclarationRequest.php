...
class CreateCustomsDeclarationRequest
{
     ...
     *
     * @var \Shippo\API\Models\Components\CustomsDeclarationCreateRequest $customsDeclarationCreateRequest
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public Components\CustomsDeclarationCreateRequest $customsDeclarationCreateRequest;
     ...
     * @phpstan-pure
     */
    public function __construct(Components\CustomsDeclarationCreateRequest $customsDeclarationCreateRequest, ?string $shippoApiVersion = '2018-02-08')
    {
