...
class CreateAddressRequest
{
     ...
     * Address details.
     *
     * @var \Shippo\API\Models\Components\AddressCreateRequest $addressCreateRequest
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public Components\AddressCreateRequest $addressCreateRequest;
     ...
     * @phpstan-pure
     */
    public function __construct(Components\AddressCreateRequest $addressCreateRequest, ?string $shippoApiVersion = '2018-02-08')
    {
