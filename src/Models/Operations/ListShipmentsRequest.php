...
class ListShipmentsRequest
{
     ...
     * @phpstan-pure
     */
    public function __construct(?string $pageToken = null, ?string $objectCreatedGt = null, ?string $objectCreatedGte = null, ?string $objectCreatedLt = null, ?string $objectCreatedLte = null, ?int $page = 1, ?int $results = 25, ?string $shippoApiVersion = '2018-02-08')
    {
