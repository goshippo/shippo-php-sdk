...
class ListCarrierAccountsRequest
{
     ...
     * @param  ?\Shippo\API\Models\Components\CarriersEnum  $carrier
     ...
     * @phpstan-pure
     */
    public function __construct(?bool $serviceLevels = null, ?Components\CarriersEnum $carrier = null, ?string $accountId = null, ?int $page = 1, ?int $results = 5, ?string $shippoApiVersion = '2018-02-08')
    {
