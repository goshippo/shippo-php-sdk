...
class CreateTrackRequest
{
    /**
     *
     * @var \Shippo\API\Models\Components\TracksRequest $tracksRequest
     */
     ...
     * @phpstan-pure
     */
    public function __construct(Components\TracksRequest $tracksRequest, ?string $shippoApiVersion = '2018-02-08')
    {
