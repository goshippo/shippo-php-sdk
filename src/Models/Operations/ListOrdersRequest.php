...
class ListOrdersRequest
{
     ...
     *
     * @var ?array<\Shippo\API\Models\Components\OrderStatusEnum> $orderStatus
     */
     ...
     * @param  ?array<\Shippo\API\Models\Components\OrderStatusEnum>  $orderStatus
     * @param  ?\Shippo\API\Models\Components\OrderShopAppEnum  $shopApp
     * @param  ?string  $startDate
     * @param  ?string  $endDate
     * @phpstan-pure
     */
    public function __construct(?array $orderStatus = null, ?Components\OrderShopAppEnum $shopApp = null, ?string $startDate = null, ?string $endDate = null, ?int $page = 1, ?int $results = 25, ?string $shippoApiVersion = '2018-02-08')
    {
