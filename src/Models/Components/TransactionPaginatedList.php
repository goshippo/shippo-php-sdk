...
class TransactionPaginatedList
{
     ...
     * $results
     *
     * @var ?array<\Shippo\API\Models\Components\Transaction> $results
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('results')]
    #[\Speakeasy\Serializer\Annotation\Type('array<\Shippo\API\Models\Components\Transaction>|null')]
    #[\Speakeasy\Serializer\Annotation\SkipWhenNull]
     ...
     * @param  ?array<\Shippo\API\Models\Components\Transaction>  $results
     * @phpstan-pure
     */
