...
class ManifestPaginatedList
{
     ...
     * $results
     *
     * @var ?array<\Shippo\API\Models\Components\Manifest> $results
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('results')]
    #[\Speakeasy\Serializer\Annotation\Type('array<\Shippo\API\Models\Components\Manifest>|null')]
    #[\Speakeasy\Serializer\Annotation\SkipWhenNull]
     ...
     * @param  ?array<\Shippo\API\Models\Components\Manifest>  $results
     * @phpstan-pure
     */
