...
class CustomsDeclarationCreateRequest
{
    ...
    /**
     *
     * @var \Shippo\API\Models\Components\CustomsDeclarationContentsTypeEnum $contentsType
     */
    ...
    /**
     *
     * @var \Shippo\API\Models\Components\CustomsDeclarationNonDeliveryOptionEnum $nonDeliveryOption
     */
    ...
    /**
     *
     * @var ?\Shippo\API\Models\Components\CustomsDeclarationB13AFilingOptionEnum $b13aFilingOption
     */
     ...
     *
     * @var ?\Shippo\API\Models\Components\DutiesPayor $dutiesPayor
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('duties_payor')]
    #[\Speakeasy\Serializer\Annotation\Type('\Shippo\API\Models\Components\DutiesPayor|null')]
    #[\Speakeasy\Serializer\Annotation\SkipWhenNull]
    public ?DutiesPayor $dutiesPayor = null;
    ...
    /**
     *
     * @var ?\Shippo\API\Models\Components\CustomsDeclarationEelPfcEnum $eelPfc
     */
    ...
    /**
     *
     * @var ?\Shippo\API\Models\Components\CustomsDeclarationIncotermEnum $incoterm
     */
     ...
     * @param  \Shippo\API\Models\Components\CustomsDeclarationContentsTypeEnum  $contentsType
     * @param  array<\Shippo\API\Models\Components\CustomsItemCreateRequest>  $items
     * @param  \Shippo\API\Models\Components\CustomsDeclarationNonDeliveryOptionEnum  $nonDeliveryOption
     * @param  ?string  $aesItn
     * @param  ?\Shippo\API\Models\Components\CustomsDeclarationB13AFilingOptionEnum  $b13aFilingOption
     * @param  ?string  $b13aNumber
     * @param  ?string  $certificate
     * @param  ?bool  $commercialInvoice
     * @param  ?string  $contentsExplanation
     * @param  ?string  $disclaimer
     * @param  ?\Shippo\API\Models\Components\DutiesPayor  $dutiesPayor
     * @param  ?\Shippo\API\Models\Components\CustomsExporterIdentification  $exporterIdentification
     ...
     * @param  ?string  $notes
     * @param  ?\Shippo\API\Models\Components\AddressImporter  $addressImporter
     * @param  ?\Shippo\API\Models\Components\CustomsDeclarationEelPfcEnum  $eelPfc
     * @param  ?\Shippo\API\Models\Components\CustomsDeclarationIncotermEnum  $incoterm
     * @param  ?bool  $test
     * @phpstan-pure
     */
