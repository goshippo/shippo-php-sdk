 ...
 *
 */
enum ParcelTemplateFedExEnum: string
{
    case FedExBox10kg = 'FedEx_Box_10kg';
    case FedExBox25kg = 'FedEx_Box_25kg';
    case FedExBoxExtraLarge1 = 'FedEx_Box_Extra_Large_1';
    case FedExBoxExtraLarge2 = 'FedEx_Box_Extra_Large_2';
    case FedExBoxLarge1 = 'FedEx_Box_Large_1';
    case FedExBoxLarge2 = 'FedEx_Box_Large_2';
    case FedExBoxMedium1 = 'FedEx_Box_Medium_1';
    case FedExBoxMedium2 = 'FedEx_Box_Medium_2';
    case FedExBoxSmall1 = 'FedEx_Box_Small_1';
    case FedExBoxSmall2 = 'FedEx_Box_Small_2';
    case FedExEnvelope = 'FedEx_Envelope';
    case FedExPaddedPak = 'FedEx_Padded_Pak';
    case FedExPak1 = 'FedEx_Pak_1';
    case FedExPak2 = 'FedEx_Pak_2';
    case FedExTube = 'FedEx_Tube';
    case FedExXLPak = 'FedEx_XL_Pak';
}
