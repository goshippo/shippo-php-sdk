...
class OrderPaginatedList
{
     ...
     * $results
     *
     * @var ?array<\Shippo\API\Models\Components\Order> $results
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('results')]
    #[\Speakeasy\Serializer\Annotation\Type('array<\Shippo\API\Models\Components\Order>|null')]
    #[\Speakeasy\Serializer\Annotation\SkipWhenNull]
     ...
     * @param  ?array<\Shippo\API\Models\Components\Order>  $results
     * @phpstan-pure
     */
