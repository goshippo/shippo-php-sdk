...
class ShipmentCreateRequest
{
    /**
     *
     * @var \Shippo\API\Models\Components\AddressCreateRequest|string $addressFrom
     */
    ...
    /**
     *
     * @var \Shippo\API\Models\Components\AddressCreateRequest|string $addressTo
     */
     ...
     * | FedEx | Max 30 items |
     *
     * @var array<\Shippo\API\Models\Components\ParcelCreateRequest|\Shippo\API\Models\Components\ParcelCreateFromTemplateRequest|string> $parcels
     */
    ...
    /**
     *
     * @var \Shippo\API\Models\Components\AddressCreateRequest|string|null $addressReturn
     */
    ...
    /**
     *
     * @var \Shippo\API\Models\Components\CustomsDeclarationCreateRequest|string|null $customsDeclaration
     */
    ...
    /**
     * @param  \Shippo\API\Models\Components\AddressCreateRequest|string  $addressFrom
     * @param  \Shippo\API\Models\Components\AddressCreateRequest|string  $addressTo
     * @param  array<\Shippo\API\Models\Components\ParcelCreateRequest|\Shippo\API\Models\Components\ParcelCreateFromTemplateRequest|string>  $parcels
     * @param  ?\Shippo\API\Models\Components\ShipmentExtra  $extra
     * @param  ?string  $metadata
     * @param  ?string  $shipmentDate
     * @param  \Shippo\API\Models\Components\AddressCreateRequest|string|null  $addressReturn
     * @param  \Shippo\API\Models\Components\CustomsDeclarationCreateRequest|string|null  $customsDeclaration
     * @param  ?bool  $async
