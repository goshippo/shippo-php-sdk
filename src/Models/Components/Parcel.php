...
class Parcel
{
    ...
    #[\Speakeasy\Serializer\Annotation\SkipWhenNull]
    public ParcelTemplateFedExEnum|ParcelTemplateUPSEnum|ParcelTemplateUSPSEnum|ParcelTemplateDHLeCommerceEnum|ParcelTemplateDPDUKEnum|ParcelTemplateAramexAustraliaEnum|null $template = null;
     ...
     * @param  string  $weight
     * @param  \Shippo\API\Models\Components\DistanceUnitEnum  $distanceUnit
     * @param  string  $height
     * @param  string  $length
     * @param  string  $width
     ...
     * @param  ?\Shippo\API\Models\Components\ObjectState  $objectState
