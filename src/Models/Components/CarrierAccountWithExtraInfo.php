...
class CarrierAccountWithExtraInfo
{
    ...
    /**
     *
     * @var array<string, mixed>|\Shippo\API\Models\Components\FedExConnectExistingOwnAccountParameters|\Shippo\API\Models\Components\UPSConnectExistingOwnAccountParameters|null $parameters
     */
     ...
     * @param  ?bool  $active
     * @param  array<string, mixed>|\Shippo\API\Models\Components\FedExConnectExistingOwnAccountParameters|\Shippo\API\Models\Components\UPSConnectExistingOwnAccountParameters|null  $parameters
     * @param  mixed  $carrierName
     * @param  ?bool  $isShippoAccount
     * @param  ?string  $metadata
     * @param  ?string  $objectId
     * @param  ?string  $objectOwner
     * @param  ?array<\Shippo\API\Models\Components\CarrierAccountServiceLevel>  $serviceLevels
     * @param  ?bool  $test
     * @param  ?\Shippo\API\Models\Components\ObjectInfo  $objectInfo
     * @phpstan-pure
     */
