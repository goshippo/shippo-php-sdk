...
class CarrierAccountMondialRelayCreateRequest
{
    /**
     *
     * @var \Shippo\API\Models\Components\CarrierAccountMondialRelayCreateRequestParameters $parameters
     */
     ...
     * @param  \Shippo\API\Models\Components\CarrierAccountMondialRelayCreateRequestParameters  $parameters
     * @phpstan-pure
     */
