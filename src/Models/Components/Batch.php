...
class Batch
{
    ...
    /**
     *
     * @var \Shippo\API\Models\Components\BatchShipmentPaginatedList $batchShipments
     */
     ...
     * @param  \Shippo\API\Models\Components\BatchShipmentPaginatedList  $batchShipments
     * @param  array<string>  $labelUrl
     * @param  string  $objectCreated
     * @param  string  $objectId
     * @param  string  $objectOwner
     * @param  \Shippo\API\Models\Components\ObjectResults  $objectResults
     * @param  string  $objectUpdated
     * @param  \Shippo\API\Models\Components\BatchStatus  $status
