...
class Shipment
{
    ...
    /**
     *
     * @var ?\Shippo\API\Models\Components\CustomsDeclaration $customsDeclaration
     */
     ...
     * @param  \Shippo\API\Models\Components\Address  $addressFrom
     * @param  \Shippo\API\Models\Components\Address  $addressTo
     ...
     * @param  array<\Shippo\API\Models\Components\Parcel>  $parcels
     * @param  array<\Shippo\API\Models\Components\Rate>  $rates
     * @param  \Shippo\API\Models\Components\ShipmentStatus  $status
     * @param  ?\Shippo\API\Models\Components\ShipmentExtra  $extra
     * @param  ?string  $shipmentDate
     * @param  ?\Shippo\API\Models\Components\Address  $addressReturn
     * @param  ?\Shippo\API\Models\Components\CustomsDeclaration  $customsDeclaration
     * @param  ?bool  $test
     * @phpstan-pure
     */
