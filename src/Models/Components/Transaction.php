...
class Transaction
{
     ...
     *
     * @var \Shippo\API\Models\Components\CoreRate|string|null $rate
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('rate')]
    #[\Speakeasy\Serializer\Annotation\Type('\Shippo\API\Models\Components\CoreRate|string|null')]
    #[\Speakeasy\Serializer\Annotation\SkipWhenNull]
    ...
    /**
     *
     * @var ?\Shippo\API\Models\Components\CreatedBy $createdBy
     */
     ...
     * @param  ?string  $eta
     * @param  ?\Shippo\API\Models\Components\LabelFileTypeEnum  $labelFileType
     ...
     * @param  ?\Shippo\API\Models\Components\ObjectStateEnum  $objectState
     * @param  ?\DateTime  $objectUpdated
     * @param  ?string  $parcel
     * @param  ?string  $qrCodeUrl
     * @param  \Shippo\API\Models\Components\CoreRate|string|null  $rate
     * @param  ?\Shippo\API\Models\Components\TransactionStatusEnum  $status
     * @param  ?bool  $test
     * @param  ?string  $trackingNumber
     * @param  ?\Shippo\API\Models\Components\TrackingStatusEnum  $trackingStatus
     * @param  ?string  $trackingUrlProvider
     * @param  ?\Shippo\API\Models\Components\CreatedBy  $createdBy
     * @phpstan-pure
     */
