...
/** ParcelInsurance - To add insurance to your parcel, specify `amount`, `content` and `currency`. If you do not want to add insurance to your parcel, do not set these parameters. */
class ParcelInsurance
{
     ...
     * @param  ?\Shippo\API\Models\Components\ParcelInsuranceProvider  $provider
     * @phpstan-pure
     */
