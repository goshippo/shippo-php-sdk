...
class TrackingStatus
{
     ...
     * @param  \Shippo\API\Models\Components\TrackingStatusEnum  $status
     * @param  string  $statusDetails
     * @param  ?\Shippo\API\Models\Components\TrackingStatusLocationBase  $location
     * @param  ?\Shippo\API\Models\Components\TrackingStatusSubstatus  $substatus
