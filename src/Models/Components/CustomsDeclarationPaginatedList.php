...
class CustomsDeclarationPaginatedList
{
     ...
     * $results
     *
     * @var ?array<\Shippo\API\Models\Components\CustomsDeclaration> $results
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('results')]
    #[\Speakeasy\Serializer\Annotation\Type('array<\Shippo\API\Models\Components\CustomsDeclaration>|null')]
    #[\Speakeasy\Serializer\Annotation\SkipWhenNull]
     ...
     * @param  ?array<\Shippo\API\Models\Components\CustomsDeclaration>  $results
     * @phpstan-pure
     */
