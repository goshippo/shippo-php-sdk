...
class Address
{
     ...
     * @var ?bool $isComplete
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('is_complete')]
    #[\Speakeasy\Serializer\Annotation\SkipWhenNull]
     ...
     * Latitude of address
     *
     * @var float|string|null $latitude
     */
     ...
     *
     * @var float|string|null $longitude
     */
     ...
     *
     * @var ?AddressValidationResults $validationResults
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('validation_results')]
    #[\Speakeasy\Serializer\Annotation\Type('\Shippo\API\Models\Components\AddressValidationResults|null')]
    #[\Speakeasy\Serializer\Annotation\SkipWhenNull]
