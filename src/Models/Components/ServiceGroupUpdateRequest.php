...
class ServiceGroupUpdateRequest
{
     ...
     * @param  string  $name
     * @param  \Shippo\API\Models\Components\ServiceGroupTypeEnum  $type
     * @param  string  $objectId
     * @param  bool  $isActive
     * @param  array<\Shippo\API\Models\Components\ServiceGroupAccountAndServiceLevel>  $serviceLevels
     ...
     * @phpstan-pure
     */
    public function __construct(string $description, string $name, ServiceGroupTypeEnum $type, string $objectId, bool $isActive, array $serviceLevels, ?string $flatRate = null, ?string $flatRateCurrency = null, ?string $freeShippingThresholdCurrency = null, ?string $freeShippingThresholdMin = null, ?int $rateAdjustment = null)
    {
