...
class CarrierAccountPosteItalianeCreateRequest
{
    /**
     *
     * @var \Shippo\API\Models\Components\CarrierAccountPosteItalianeCreateRequestParameters $parameters
     */
     ...
     * @param  \Shippo\API\Models\Components\CarrierAccountPosteItalianeCreateRequestParameters  $parameters
     * @phpstan-pure
     */
