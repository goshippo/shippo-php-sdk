...
class Rate
{
    ...
    /**
     *
     * @var \Shippo\API\Models\Components\ServiceLevelWithParent $servicelevel
     */
     ...
     * @param  array<\Shippo\API\Models\Components\Attributes>  $attributes
     * @param  string  $carrierAccount
     * @param  \DateTime  $objectCreated
     * @param  string  $objectId
     * @param  string  $objectOwner
     * @param  string  $provider
     * @param  \Shippo\API\Models\Components\ServiceLevelWithParent  $servicelevel
     * @param  string  $shipment
     * @param  ?string  $arrivesBy
     * @param  ?string  $durationTerms
     * @param  ?int  $estimatedDays
     * @param  ?string  $includedInsurancePrice
     * @param  ?array<\Shippo\API\Models\Components\ResponseMessage>  $messages
