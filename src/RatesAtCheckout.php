...
class RatesAtCheckout
{
     ...
     * @return \Shippo\API\Models\Components\LiveRatePaginatedList
    ...
    public function create(Components\LiveRateCreateRequest $liveRateCreateRequest, ?string $shippoApiVersion = null, ?Options $options = null): Components\LiveRatePaginatedList
    {
        ...
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'CreateLiveRate', null, $this->sdkConfiguration->securitySource);
    ...
    public function deleteDefaultParcelTemplate(?string $shippoApiVersion = null, ?Options $options = null): void
    {
        ...
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'DeleteDefaultParcelTemplate', null, $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $httpOptions = Utils\Utils::convertHeadersToOptions($httpRequest, $httpOptions);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
        try {
     ...
     *
     * @param  ?string  $shippoApiVersion
     * @return \Shippo\API\Models\Components\DefaultParcelTemplate
     * @throws \Shippo\API\Models\Errors\SDKError
     */
    public function getDefaultParcelTemplate(?string $shippoApiVersion = null, ?Options $options = null): Components\DefaultParcelTemplate
    {
        ...
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'GetDefaultParcelTemplate', null, $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $httpOptions = Utils\Utils::convertHeadersToOptions($httpRequest, $httpOptions);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
        try {
    ...
    public function updateDefaultParcelTemplate(?Components\DefaultParcelTemplateUpdateRequest $defaultParcelTemplateUpdateRequest = null, ?string $shippoApiVersion = null, ?Options $options = null): Components\DefaultParcelTemplate
    {
        ...
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'UpdateDefaultParcelTemplate', null, $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $httpOptions = Utils\Utils::convertHeadersToOptions($httpRequest, $httpOptions);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
        try {
