...
class Batches
{
     ...
     * @return \Shippo\API\Models\Components\Batch
    ...
    public function addShipments(array $requestBody, string $batchId, ?string $shippoApiVersion = null, ?Options $options = null): Components\Batch
    {
        ...
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'AddShipmentsToBatch', null, $this->sdkConfiguration->securitySource);
    ...
    public function create(Components\BatchCreateRequest $batchCreateRequest, ?string $shippoApiVersion = null, ?Options $options = null): Components\Batch
    {
        ...
        $httpOptions['headers']['user-agent'] = $this->sdkConfiguration->userAgent;
        $httpRequest = new \GuzzleHttp\Psr7\Request('POST', $url);
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'CreateBatch', null, $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $httpOptions = Utils\Utils::convertHeadersToOptions($httpRequest, $httpOptions);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
        try {
     ...
     *
     * @param  \Shippo\API\Models\Operations\GetBatchRequest  $request
     * @return \Shippo\API\Models\Components\Batch
     * @throws \Shippo\API\Models\Errors\SDKError
     */
    public function get(Operations\GetBatchRequest $request, ?Options $options = null): Components\Batch
    {
        ...
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'GetBatch', null, $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
    ...
    public function purchase(string $batchId, ?string $shippoApiVersion = null, ?Options $options = null): Components\Batch
    {
        ...
        $httpOptions['headers']['user-agent'] = $this->sdkConfiguration->userAgent;
        $httpRequest = new \GuzzleHttp\Psr7\Request('POST', $url);
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'PurchaseBatch', null, $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $httpOptions = Utils\Utils::convertHeadersToOptions($httpRequest, $httpOptions);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
        try {
    ...
    public function removeShipments(array $requestBody, string $batchId, ?string $shippoApiVersion = null, ?Options $options = null): Components\Batch
    {
        ...
        $httpOptions['headers']['user-agent'] = $this->sdkConfiguration->userAgent;
        $httpRequest = new \GuzzleHttp\Psr7\Request('POST', $url);
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'RemoveShipmentsFromBatch', null, $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $httpOptions = Utils\Utils::convertHeadersToOptions($httpRequest, $httpOptions);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
        try {
