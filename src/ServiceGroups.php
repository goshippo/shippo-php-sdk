...
class ServiceGroups
{
     ...
     * @return \Shippo\API\Models\Components\ServiceGroup
    ...
    public function create(Components\ServiceGroupCreateRequest $serviceGroupCreateRequest, ?string $shippoApiVersion = null, ?Options $options = null): Components\ServiceGroup
    {
        ...
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'CreateServiceGroup', null, $this->sdkConfiguration->securitySource);
    ...
    public function delete(string $serviceGroupId, ?string $shippoApiVersion = null, ?Options $options = null): void
    {
        ...
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'DeleteServiceGroup', null, $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $httpOptions = Utils\Utils::convertHeadersToOptions($httpRequest, $httpOptions);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
        try {
     ...
     *
     * @param  ?string  $shippoApiVersion
     * @return array<\Shippo\API\Models\Components\ServiceGroup>
     * @throws \Shippo\API\Models\Errors\SDKError
     */
    public function list(?string $shippoApiVersion = null, ?Options $options = null): array
    {
        ...
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'ListServiceGroups', null, $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $httpOptions = Utils\Utils::convertHeadersToOptions($httpRequest, $httpOptions);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
        try {
    ...
    public function update(?Components\ServiceGroupUpdateRequest $serviceGroupUpdateRequest = null, ?string $shippoApiVersion = null, ?Options $options = null): Components\ServiceGroup
    {
        ...
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'UpdateServiceGroup', null, $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $httpOptions = Utils\Utils::convertHeadersToOptions($httpRequest, $httpOptions);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
        try {
