...
class UserParcelTemplates
{
     ...
     * @return \Shippo\API\Models\Components\UserParcelTemplate
    ...
    public function create(Components\UserParcelTemplateWithCarrierTemplateCreateRequest|Components\UserParcelTemplateWithoutCarrierTemplateCreateRequest $userParcelTemplateCreateRequest, ?string $shippoApiVersion = null, ?Options $options = null): Components\UserParcelTemplate
    {
        ...
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'CreateUserParcelTemplate', null, $this->sdkConfiguration->securitySource);
    ...
    public function delete(string $userParcelTemplateObjectId, ?string $shippoApiVersion = null, ?Options $options = null): void
    {
        ...
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'DeleteUserParcelTemplate', null, $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $httpOptions = Utils\Utils::convertHeadersToOptions($httpRequest, $httpOptions);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
        try {
    ...
    public function get(string $userParcelTemplateObjectId, ?string $shippoApiVersion = null, ?Options $options = null): Components\UserParcelTemplate
    {
        ...
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'GetUserParcelTemplate', null, $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $httpOptions = Utils\Utils::convertHeadersToOptions($httpRequest, $httpOptions);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
        try {
     ...
     *
     * @param  ?string  $shippoApiVersion
     * @return \Shippo\API\Models\Components\UserParcelTemplateList
     * @throws \Shippo\API\Models\Errors\SDKError
     */
    public function list(?string $shippoApiVersion = null, ?Options $options = null): Components\UserParcelTemplateList
    {
        ...
        $httpOptions['headers']['user-agent'] = $this->sdkConfiguration->userAgent;
        $httpRequest = new \GuzzleHttp\Psr7\Request('GET', $url);
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'ListUserParcelTemplates', null, $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $httpOptions = Utils\Utils::convertHeadersToOptions($httpRequest, $httpOptions);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
        try {
    ...
    public function update(string $userParcelTemplateObjectId, ?Components\UserParcelTemplateUpdateRequest $userParcelTemplateUpdateRequest = null, ?string $shippoApiVersion = null, ?Options $options = null): Components\UserParcelTemplate
    {
        ...
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'UpdateUserParcelTemplate', null, $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $httpOptions = Utils\Utils::convertHeadersToOptions($httpRequest, $httpOptions);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
        try {
