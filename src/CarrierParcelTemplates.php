...
class CarrierParcelTemplates
{
     ...
     * @return \Shippo\API\Models\Components\CarrierParcelTemplate
    ...
    public function get(string $carrierParcelTemplateToken, ?string $shippoApiVersion = null, ?Options $options = null): Components\CarrierParcelTemplate
    {
        ...
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'GetCarrierParcelTemplate', null, $this->sdkConfiguration->securitySource);
     ...
     * @param  ?string  $shippoApiVersion
     * @return \Shippo\API\Models\Components\CarrierParcelTemplateList
     * @throws \Shippo\API\Models\Errors\SDKError
     */
    public function list(?Operations\IncludeT $include = null, ?string $carrier = null, ?string $shippoApiVersion = null, ?Options $options = null): Components\CarrierParcelTemplateList
    {
        ...
        $httpOptions['headers']['user-agent'] = $this->sdkConfiguration->userAgent;
        $httpRequest = new \GuzzleHttp\Psr7\Request('GET', $url);
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'ListCarrierParcelTemplates', null, $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
