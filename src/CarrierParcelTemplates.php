...
class CarrierParcelTemplates
{
     ...
     */
    public function list(?Operations\IncludeT $include = null, ?string $carrier = null, ?string $shippoApiVersion = null): Components\CarrierParcelTemplateList
    {
     ...
     * @throws \Shippo\API\Models\Errors\SDKError
     */
    public function get(string $carrierParcelTemplateToken, ?string $shippoApiVersion = null): Components\CarrierParcelTemplate
    {
