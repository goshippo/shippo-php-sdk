...
class ShippoAccounts
{
     ...
     */
    public function list(?int $page = null, ?int $results = null, ?string $shippoApiVersion = null): Components\ShippoAccountPaginatedList
    {
     ...
     * @throws \Shippo\API\Models\Errors\SDKError
     */
    public function create(Components\ShippoAccountUpdateRequest $shippoAccountUpdateRequest, ?string $shippoApiVersion = null): Components\ShippoAccount
    {
     ...
     * @throws \Shippo\API\Models\Errors\SDKError
     */
    public function get(string $shippoAccountId, ?string $shippoApiVersion = null): Components\ShippoAccount
    {
     ...
     * @throws \Shippo\API\Models\Errors\SDKError
     */
    public function update(string $shippoAccountId, ?Components\ShippoAccountUpdateRequest $shippoAccountUpdateRequest = null, ?string $shippoApiVersion = null): Components\ShippoAccount
    {
